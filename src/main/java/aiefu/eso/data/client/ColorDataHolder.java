...
public class ColorDataHolder{
    ...
    public ColorDataHolder(BackgroundColorData bcd, SliderColorData scd, TextSettings tx){
        ...
        this.textActiveColor = TextColor.parseColor(tx.activeColor).getValue();
        this.textInactiveColor = TextColor.parseColor(tx.inactiveColor).getValue();
        this.dropShadow = tx.dropShadow;

        this.searchBarHintColor = TextColor.parseColor(tx.searchBarHintColor).getValue();
